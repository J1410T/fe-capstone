...
interface BM4FormData extends FormData {
  projectTitle: string;
...
interface BM4FormProps {
  formData: BM4FormData;
  onDataChange: (data: BM4FormData) => void;
  onSubmit: () => void;
}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleInputChange("progressSummary", e.target.value)
                }
            ...
            <div className="space-y-2">
              <Label htmlFor="completedActivities">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleInputChange("completedActivities", e.target.value)
                }
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(e) =>
                  handleInputChange("upcomingActivities", e.target.value)
                }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("budgetUtilized", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange("budgetRemaining", e.target.value)
                  }
