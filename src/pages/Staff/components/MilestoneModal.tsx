...
// // Utility function to get current datetime in local format
...
//   useEffect(() => {
//     const errors = validateDates(formData["start-date"], formData["end-date"]);
//     setValidationErrors(errors);
//   }, [formData["start-date"], formData["end-date"], validateDates]);
