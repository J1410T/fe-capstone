...
//   try {
//     const accessToken = getAccessToken();
//     const res = await axiosClient.post<ProjectMajorFilterResponse>(
//       "/major/filter",
//       request,
//       {
//         headers: {
...
//   try {
//     const accessToken = getAccessToken();
//     const res = await axiosClient.post<MajorResponse>("/major", data, {
//       headers: {
//         Authorization: `Bearer ${accessToken}`,
//         "Content-Type": "application/json-patch+json",
//       },
...
//   try {
//     const accessToken = getAccessToken();
//     const res = await axiosClient.put<MajorResponse>(`/major/${id}`, data, {
//       headers: {
//         Authorization: `Bearer ${accessToken}`,
//         "Content-Type": "application/json-patch+json",
//       },
